...
class Panel:
    ...
    def __init__(self, varname:str, panel_type_str:str, source:PanelSource, aspect_ratio:float=1.5, is_local:bool=False,
...
class ImagePanel(Panel):
    def __init__(self, varname: str, aspect_ratio: float = 1.5, is_local: bool = False,
                 source:PanelSource=FilePanelSource()) -> None:
        super().__init__(varname, Panel._PANEL_TYPE_IMAGE, source, aspect_ratio, is_local, is_image=True, writeable=False)
...
class IFramePanel(Panel):
    def __init__(self, varname: str, aspect_ratio: float = 1.5, is_local: bool = False,
                 source:PanelSource=FilePanelSource()) -> None:
        super().__init__(varname, Panel._PANEL_TYPE_IFRAME, source, aspect_ratio, is_local, is_image=False, writeable=False)

class FigurePanel(Panel):
    def __init__(self, varname: str, extension: str = "png", aspect_ratio: float = 1.5,
                 is_local: bool = True, source:PanelSource=FilePanelSource()) -> None:
        super().__init__(varname, Panel._PANEL_TYPE_IMAGE, source, aspect_ratio, is_local, is_image=False, writeable=True)
